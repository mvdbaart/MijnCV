        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {timeline.map((entry, i) => (
              ...
              >
                {/* dot */}
                <div className="absolute left-3 top-1 flex h-5 w-5 items-center justify-center rounded-full border border-white/20 bg-gray-900 md:left-[14px]">
                  {entry.type === "work" ? (
                ...
                {/* card */}
                <div className="flex-1 rounded-xl border border-white/[0.08] bg-white/[0.04] p-5">
